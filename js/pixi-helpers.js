...
Actor.prototype.changeImage = function(img) {
  this.prepareImage(img)
  this.sprite.setTexture(this.imgCache[img])
}
Actor.prototype.prepareImage = function(img) {
  if(!this.imgCache) this.imgCache = {}
  const texture = this.imgCache[img] || new PIXI.Texture.fromImage(img)
  this.imgCache[img] = texture
}
